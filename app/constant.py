...
MIN_HEIGHT_BLANK_BETWEEN_REGIONS_MIN_VALUE = 0
MIN_HEIGHT_BLANK_BETWEEN_REGIONS_MAX_VALUE = 5

THRESHOLD_DETECTING_COLUMN_GAPS_ARG_NAME = "-gtc"
THRESHOLD_DETECTING_GAPS_BETWEEN_ROWS_ARG_NAME = "-gtr"
THRESHOLD_DETECTING_WORD_GAPS_ARG_NAME = "-gtw"
