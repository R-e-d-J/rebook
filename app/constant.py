...
CROPBOX_6_ARG_NAME = "cbox_6"
CROPBOX_7_ARG_NAME = "cbox_7"
CROPBOX_8_ARG_NAME = "cbox_8"
CROPBOX_9_ARG_NAME = "cbox_9"
CROPBOX_10_ARG_NAME = "cbox_10"
CROPBOXU_ARG_NAME = "-cboxu"
...
AUTO_CROP_MIN_VALUE = 0.1
AUTO_CROP_MAX_VALUE = 1.0
...
MIN_COLUMN_GAP_WIDTH_MIN_VALUE = 0.00
MIN_COLUMN_GAP_WIDTH_MAX_VALUE = 5.00

MAX_GAP_BETWEEN_COLUMN_ARG_NAME = "-cgmax"
MAX_GAP_BETWEEN_COLUMN_MIN_VALUE = 0.00
MAX_GAP_BETWEEN_COLUMN_MAX_VALUE = 5.00

COLUMN_GAP_RANGE_ARG_NAME = "-cgr"
COLUMN_GAP_RANGE_MIN_VALUE = 0.01
COLUMN_GAP_RANGE_MAX_VALUE = 1.00

MINIMUM_COLUMN_HEIGHT_ARG_NAME = "-ch"
MINIMUM_COLUMN_HEIGHT_MIN_VALUE = 0.00
MINIMUM_COLUMN_HEIGHT_MAX_VALUE = 6.00

COLUMN_OFFSET_MAXIMUM_ARG_NAME = "-comax"
COLUMN_OFFSET_MAXIMUM_MIN_VALUE = 0.0
COLUMN_OFFSET_MAXIMUM_MAX_VALUE = 1.0

MIN_HEIGHT_BLANK_BETWEEN_REGIONS_ARG_NAME = "-crgh"  ###
MIN_HEIGHT_BLANK_BETWEEN_REGIONS_MIN_VALUE = 0.001
MIN_HEIGHT_BLANK_BETWEEN_REGIONS_MAX_VALUE = 2.500

THRESHOLD_DETECTING_GAPS_BETWEEN_COLUMN_ARG_NAME = "-gtc"
THRESHOLD_DETECTING_GAPS_BETWEEN_COLUMN_MIN_VALUE = 0.001
THRESHOLD_DETECTING_GAPS_BETWEEN_COLUMN_MAX_VALUE = 2.500

THRESHOLD_DETECTING_GAPS_BETWEEN_ROWS_ARG_NAME = "-gtr"
THRESHOLD_DETECTING_GAPS_BETWEEN_ROWS_MIN_VALUE = 0.001
THRESHOLD_DETECTING_GAPS_BETWEEN_ROWS_MAX_VALUE = 2.500

THRESHOLD_DETECTING_GAPS_BETWEEN_WORDS_ARG_NAME = "-gtw"
THRESHOLD_DETECTING_GAPS_BETWEEN_WORDS_MIN_VALUE = 0.0001
THRESHOLD_DETECTING_GAPS_BETWEEN_WORDS_MAX_VALUE = 1.0000

TEXT_ONLY_OUTPUT_ARG_NAME = "-to"
GAP_SIZE_VERTICAL_BREAK_THRESHOLD_BETWEEN_REGIONS_ARG_NAME = "-vb"
